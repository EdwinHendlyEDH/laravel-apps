...
<body class="">
    ...
    <div class="modal-create relative">
        <form action="/murid/{{$dataId->id}}" method="post">
            @method('put');
            @csrf
            ...
            <h2 class="text-5xl font-bold text-[#F4A261] w-full before:absolute before:left-0 before:-bottom-2 relative before:w-8 before:h-1 before:bg-[#F4A261] mb-10">Tambah Murid <i class="fa-solid fa-address-card ml-5"></i></h2>
            ...
            <div class="form-data">
                <div class="part-one">
                    <ul>
                        ...
                        <li>
                            ...
                            <input type='text' name='kelas' id='kelas' value="{{$dataId->kelas}}">
                        </li>

                        <li>
                            <label for='umur'><i class="fa-solid fa-arrow-up-1-9 mr-1"></i> umur </label>
                            <input type='text' name='umur' id='umur' value="{{$dataId->umur}}">
                        </li>

                        <li class="w-full">
                            <label for="gender"><i class="fa-solid fa-genderless mr-1"></i>Gender</label>
                            <select name="gender" id="gender" class="w-full text-[#264653]">
                                <option value="L" @if($dataId->gender == 'L') selected @endif>L</option>
                                <option value="P" @if($dataId->gender == 'P') selected @endif>P</option>
                            </select>
                        </li>
                    </ul>
                </div>
                ...
                <div class="part-two">
                    ...
                    <textarea name="tentang_saya" id="tentang_saya">{{$dataId->tentang_saya}}</textarea>
                </div>
            </div>
            <button type="submit" class="text-white bg-[#F4A261] px-[24px] py-[7px] text-[18px] rounded-md shadow-lg uppercase font-semibold tracking-wider mt-8" name="submit"><i class="fa-solid fa-plus mr-1"></i>ubah</button>
        </form>
    </div>
